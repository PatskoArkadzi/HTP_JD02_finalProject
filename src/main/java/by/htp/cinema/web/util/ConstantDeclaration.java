...
public final class ConstantDeclaration {
	...
	// public static final String ENTITY_NAME_ROLE = "role";
	// public static final String ENTITY_NAME_USER = "user";
	// public static final String ENTITY_NAME_ORDER = "order";
	// public static final String ENTITY_NAME_TICKET = "ticket";
	// public static final String ENTITY_NAME_SEAT = "seat";
	// public static final String ENTITY_NAME_SESSION = "session";
	// public static final String ENTITY_NAME_FILM = "film";
	// public static final String ENTITY_NAME_GENRE = "genre";
