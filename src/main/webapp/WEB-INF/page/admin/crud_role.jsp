...
<div class="container">
	...
	<form class="read-role"
		action="do?action=crud_role" method=POST>
		<div class="row">
			<div class=col-md-2>
...
<div class="container">
	<c:forEach items="${rolelist}" var="role">
		...
		<form class="update-role"
			action="do?action=crud_role&role_id=${role.id}"
			method=POST>
			<div class="row">
	...
	<div class="collapse" id="collapseExample">
		<div class="card card-body">
			...
			<form class="create-role"
				action="do?action=crud_role&role_id=0"
				method=POST>
				<div class="row">
					<div class=col-md-1>${role.id}</div>
					<div class=col-md-3>
